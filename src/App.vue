...
#app.dark .custom-control-input ~ .custom-control-label::before {
  background: none !important;
}

#app.dark .custom-control-input:checked ~ .custom-control-label::before {
  color: #e14eca !important;
  border-color: #e14eca !important;
}

#app.dark .custom-control-input:focus ~ .custom-control-label::before {
  outline-color: none !important;
  box-shadow: none !important;
}

#app table td .tabel-input {
  background: none !important;
  font-weight: 200 !important;
...
#app table td .tabel-input:focus {
  outline: none;
  box-shadow: none;
}

#app button.btn:focus {
  outline: none;
  box-shadow: none;
}
</style>
